...
CREATE TABLE Attendee (
	...
	Date_Checked_In DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    	CONSTRAINT Valid_Ticket CHECK (Ticket_Type IN ('Day'
    	, 'Weekend')),
...
CREATE TABLE Event (
   	 ...
   	 Staff_Event_Runner_ID INT DEFAULT NULL,
   	 Attendee_Event_Runner_ID INT DEFAULT NULL,
  	 Max_Attendees INT DEFAULT 10,
  	 Length_Minutes INT DEFAULT 0,
...
CREATE TABLE Sale(
	...
	SKU INT NOT NULL,
	Customer_ID_Staff INT DEFAULT NULL,
	Customer_ID_Attendee INT DEFAULT NULL,
	PRIMARY KEY (Sale_ID),
...
ALTER TABLE Attendee AUTO_INCREMENT = 1000;
ALTER TABLE Sale AUTO_INCREMENT = 3000;
ALTER TABLE Event AUTO_INCREMENT = 4000;
